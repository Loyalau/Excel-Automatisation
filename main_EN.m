...
for i = 1 : Number_test_EN
    ...
    Result_table{i} = Cycle_format( Result_struct.(TestName)(1).Data,Nb_Cycle_EN); % Filling of the first 6 column (Semi Cycle, Running time, Displacement, Force, Energy of each semi cycle and Energy of a Cycle)
