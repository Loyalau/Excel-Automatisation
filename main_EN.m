...
TestName = cell(1, Number_test_EN);
for i = 1 : Number_test_EN

    TestName{i} = strrep(EN_sub_folder(i).name,'-','_'); % transform '-' into '_'
...
while ~strcmp(holeId, '#end#')
    switch holeId
        ...
        case 'Risultati_NTC'
                sprintf('Please use the main_NTC program to write this paragraph');
